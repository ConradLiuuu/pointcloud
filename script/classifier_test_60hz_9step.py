...
class Listener:
    ...
    def top5(self):
        ...
        with graph.as_default():
            self.__pred = self.__pred_top5.predict(cp.asnumpy(self.__arr_prediction.reshape(1,self.__time_step,3)))
        #print(self.__pred)
    def top6(self):
        print("top spin speed 6")
        with graph.as_default():
            self.__pred = self.__pred_top6.predict(cp.asnumpy(self.__arr_prediction.reshape(1,self.__time_step,3)))
        #print(self.__pred)
    def left5(self):
        print("left spin speed 5")
        with graph.as_default():
            self.__pred = self.__pred_left5.predict(cp.asnumpy(self.__arr_prediction.reshape(1,self.__time_step,3)))
        #print(self.__pred)
    def left6(self):
        print("left spin speed 6")
        with graph.as_default():
            self.__pred = self.__pred_left6.predict(cp.asnumpy(self.__arr_prediction.reshape(1,self.__time_step,3)))
        #print(self.__pred)
    def right5(self):
        print("right spin speed 5")
        with graph.as_default():
            self.__pred = self.__pred_right5.predict(cp.asnumpy(self.__arr_prediction.reshape(1,self.__time_step,3)))
        #print(self.__pred)
    def right6(self):
        print("right spin speed 6")
        with graph.as_default():
            self.__pred = self.__pred_right6.predict(cp.asnumpy(self.__arr_prediction.reshape(1,self.__time_step,3)))
        #print(self.__pred)
    def back5(self):
        print("back spin speed 5")
        with graph.as_default():
            self.__pred = self.__pred_back5.predict(cp.asnumpy(self.__arr_prediction.reshape(1,self.__time_step,3)))
        #print(self.__pred)
    def back6(self):
        print("back spin speed 6")
        with graph.as_default():
            self.__pred = self.__pred_back6.predict(cp.asnumpy(self.__arr_prediction.reshape(1,self.__time_step,3)))
        #print(self.__pred)
...
if __name__ == '__main__':
    ...
    print("init node classifier_test_60hz_9step.py")
    Listener()
    rospy.spin()
